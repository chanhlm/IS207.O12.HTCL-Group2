            ...
            <div class="col-6 d-flex align-items-center justify-content-center flex-column ">
                <div class="border border-light-subtle rounded-3 form">
                    <div id="sender" style="display: block;">
                        ...
                        <input class="w-100 p-2 px-3 mb-3 rounded-pill border border-danger-subtle" type="text" id="phone" placeholder="+(84) Nhập số điện thoại" required>
                        <div class="w-100 mb-3" id="recaptcha-container"></div>
                        <input class="w-100 p-2 mb-3 rounded-pill border border-danger-subtle" type="button" id="send" value="TIẾP TỤC" onClick="phoneAuth()">
                    </div>

                    <div id="verifier" style="display: none;">
                        <input type="text" id="verificationcode" placeholder="OTP Code">
                        <input type="button" id="verify" value="Verify" onClick="codeverify()">
                        <div class="p-conf">Mã OTP hợp lệ!</div>
