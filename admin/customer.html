		...
		<div class="sidebar-wrapper" data-simplebar="true">
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					...
					<ul>
						<li>
							<a href="./categories.html"><i class="bx bx-list-ul"></i>Danh sách</a>
						</li>
						<li>
							<a href="component-cards.html"><i class="bx bx-right-arrow-alt"></i>Temp</a>
						</li>
					</ul>
				</li>
				<li>
					...
					<ul>
						<li>
							<a href="./product.html"><i class="bx bxs-package"></i>Danh sách sản phẩm</a>
						</li>
						<li>
							<a href="./product-import.html"><i class="bx bx-import"></i>Nhập kho</a>
						</li>
						<li>
							<a href="./product-export.html"><i class="bx bx-export"></i>Xuất kho</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						<li>
							<a href="./customer.html"><i class="bx bx-user-pin"></i>Khách hàng</a>
						</li>
						<li>
							<a href="./employee.html"><i class="bx bxs-user-badge"></i>Nhân viên</a>
						</li>
					</ul>
				</li>
				...
				<li>
					...
					<ul>
						<li>
							<a href="./order.html"><i class="bx bx-list-ul"></i>Danh sách đơn hàng</a>
						</li>
						<li>
							<a href="./order.html"><i class="bx bx-add-to-queue"></i>Tạo hóa đơn</a>
						</li>
					</ul>
				</li>
								...
								<div class="dropdown-menu dropdown-menu-end">
									<div class="row row-cols-3 g-3 p-3">
										<div class="col text-center">
											<div class="app-box mx-auto text-primary">
												<i class="bx bx-group"></i>
											</div>
											<div class="app-title">Teams</div>
										</div>
										<div class="col text-center">
											<div class="app-box mx-auto text-danger">
												<i class="bx bx-atom"></i>
											</div>
											<div class="app-title">Projects</div>
										</div>
										<div class="col text-center">
											<div class="app-box mx-auto text-success">
												<i class="bx bx-shield"></i>
											</div>
											<div class="app-title">Tasks</div>
										</div>
										<div class="col text-center">
											<div class="app-box mx-auto text-info">
												<i class="bx bx-notification"></i>
											</div>
											<div class="app-title">Feeds</div>
										</div>
										<div class="col text-center">
											<div class="app-box mx-auto text-warning">
												<i class="bx bx-file"></i>
											</div>
											<div class="app-title">Files</div>
										</div>
										<div class="col text-center">
											<div class="app-box mx-auto text-dark">
